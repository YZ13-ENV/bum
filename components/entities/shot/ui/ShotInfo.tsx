    ...
    return (
        <div className="absolute bottom-0 left-0 flex flex-col w-full h-fit">
            <div className="relative flex items-center justify-between w-full gap-2 h-fit">
                <Link href={`/${shot.authorId}`} className="absolute left-0 w-fit h-fit flex -bottom-20 group-hover:bottom-0 items-center transition-all gap-2 px-3 py-1.5 rounded-r-lg bg-neutral-900">
                ...
                <div className="absolute right-0 flex items-center gap-2 px-3 bottom-0 transition-all w-fit h-fit rounded-l-lg py-1.5 bg-neutral-900">
