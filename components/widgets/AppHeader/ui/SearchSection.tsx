...
const SearchSection = () => {
    ...
    if (isOpen) {
        return (
            <div className="relative w-full h-full max-w-full md:max-w-md">
                <div ref={ref} 
                className="absolute left-0 z-20 flex flex-col border top-2 h-96 rounded-xl bg-neutral-900 border-neutral-700">
                    <div className="flex items-center w-full gap-2 px-3 border-b h-fit border-neutral-700">
    ...
    return (
        <div onClick={() => dispatch(setSearchOpen(true))} className="w-full max-w-full md:max-w-xs">
            <div className="flex items-center gap-1 px-3 border rounded-lg h-9 border-neutral-700 bg-neutral-900">
                <BiSearch size={17} className='inline text-neutral-500'  />
