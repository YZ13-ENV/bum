...
const Pricing = ({ hideAdvantages=false }: Props) => {
        ...
        <div className='flex flex-col items-center justify-center w-full gap-12 py-12 h-fit'>
            <div className="flex flex-col gap-8 mx-auto w-fit h-fit">
                <div className="flex items-center justify-center w-full">
                    <h1 className='text-4xl font-bold text-center md:text-5xl text-neutral-200'>
                ...
                <PricingPool isSub={isSub} forYear={forYear} />
                {
                    !hideAdvantages &&
                    <>
