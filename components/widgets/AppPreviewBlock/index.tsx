...
const AppPreviewBlock = () => {
    ...
    return (
        <animated.div style={props} className="relative w-full max-w-md p-1 my-6 overflow-hidden border border-transparent md:max-w-4xl lg:max-w-7xl group md:my-12 h-fit rounded-xl">
