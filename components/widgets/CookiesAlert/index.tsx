...
const CookiesAlert = () => {
    ...
    return (
        <div className='fixed bottom-0 left-0 z-10 w-full p-0 md:p-4'>
            <div className="flex items-center justify-between w-full max-w-xl px-4 py-2 mx-auto border rounded-none bg-neutral-950 border-neutral-900 h-14 md:rounded-lg">
