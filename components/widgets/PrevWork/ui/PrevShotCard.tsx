...
const PrevShotCard = ({ block }: Props) => {
    ...
    return (
        <div 
        className={`relative aspect-[4/3] flex items-center justify-center w-full border ${block.rootBlock.link === '' ? 'h-52' : 'h-fit'} rounded-xl shrink-0 border-neutral-800 bg-neutral-950`}>
