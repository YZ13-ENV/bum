...
const Loading = () => {
    return (
        <div className='flex flex-col w-full h-full gap-4 p-4 md:py-4 md:px-12'>
            <div className="flex items-center justify-center w-full py-3 h-fit">
                <div className="w-full h-8 max-w-lg rounded-xl bg-neutral-800 animate-pulse"></div>
            </div>
            <div className="flex justify-between w-full gap-4 py-4 shrink-0 md:gap-12 h-fit">
                <div className="w-24 h-8 rounded-xl bg-neutral-800 animate-pulse" />
                <div className="w-24 h-8 rounded-xl bg-neutral-800 animate-pulse" />
            </div>
