...
import PaymentModal from '@/components/widgets/Modal/Payment'
import { Button, Switch } from 'antd'
import PreviewGallery from '@/components/widgets/PreviewGallery/PreviewGallery'
    ...
    return (
        <section className='flex flex-col items-center justify-start w-full max-w-6xl min-h-full px-4 mx-auto'>
            ...
            <div className="flex flex-col w-full py-4 h-fit">
                <div className="flex flex-col items-center w-full gap-2 mx-auto md:flex-row h-fit">
                    ...
                    <div className="flex flex-col w-full h-64 gap-2 p-4 transition-colors duration-700 border md:w-1/4 rounded-xl border-neutral-600 group hover:border-white">
                        <div className="flex items-center justify-center w-full h-full">
                            <h3 className='text-2xl font-bold text-center transition-colors duration-700 group-hover:text-neutral-200 text-neutral-400'>Всего за 199₽</h3>
                        </div>
                    </div>
                </div>
            </div>
